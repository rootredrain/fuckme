...
def do_request(self):
    while not self.STOP_ME:
        ...
        if self.args.basic:
            ...
            params = params.split('^^^')    # params = ['ztz', '{user}123456']
            i = 0
        ...
        while err_count < max_err_count:
            try:
                ...
                if cracked_msg:
                    ...
                    self.print_s(system_encode('[+OK]' ), color_red=True)
